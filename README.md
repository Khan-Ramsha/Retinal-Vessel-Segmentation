...
> **Note:** The model shows stable in-domain performance (val/test Dice: 0.89 on FIVES, no overfitting). On cross-dataset [DRIVE](https://www.kaggle.com/datasets/ipythonx/retinal-vessel-segmentation?select=DRIVE), it maintains 96.2% accuracy despite a ~12% Dice drop from fundus acquisition shifts - demonstrating residual blocks, preprocessing and augmentation's role in generalization.
> 
## Inference
